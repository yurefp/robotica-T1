...
T1 = KR30.fkine(q1);
T2 = KR30.fkine(q1 + 0.001*dq(1:6));

delta = tr2delta(T1, T2); % Retorna [dx dy dz wx wy wz] já escalonado
d_real = delta / 0.001;

% Adjunto da transformação Efetuador da Mesa -> Efetuador do braço no waypoint 1
R = T1.R;
p = T1.t;
